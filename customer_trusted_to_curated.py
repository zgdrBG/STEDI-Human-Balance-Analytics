...
# Script generated for node Amazon S3
AmazonS3_node1718541917017 = glueContext.getSink(path="s3://aws-stedi-project/starter/customer/curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1718541917017")
AmazonS3_node1718541917017.setCatalogInfo(catalogDatabase="aws-stedi-db",catalogTableName="customer_curated")
AmazonS3_node1718541917017.setFormat("json")
AmazonS3_node1718541917017.writeFrame(DropDuplicates_node1718604351316)
job.commit()